...
[fname path]=uigetfile('C:\Users\harshinig\Desktop\Done\*.*','Select The Video or DICOM file');
...
kkk=strfind(fname,'.');
path_n='C:\Users\harshinig\Desktop\DAY2\';
s1=fname(1:kkk-1);
s1=strcat(path_n,s1);
saveas(h1,s1,'jpg');
h2=figure;
...
path1='C:\Users\harshinig\Desktop\DAY2\';
typ='.xls';
fna='case-20';
